...
query <- build_query(query = "#BLM", point_radius = c(-0.131969125179604,51.50847878040284, 25))
...
```{r, echo=F}
query <- "#BLM -is:retweet point_radius:[-0.131969125179604 51.50847878040284 25mi]"
```
