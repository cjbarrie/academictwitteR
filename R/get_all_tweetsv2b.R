...
#' @param file string, name of the resulting RDS file. Will return a data.frame if not supplied
...
#' get_all_tweetsb("BLM", "2020-01-01T00:00:00Z", "2020-01-05T00:00:00Z", bearer_token, data_path = "data/")
#' }
get_all_tweetsb <-
  function(query,
           start_tweets,
